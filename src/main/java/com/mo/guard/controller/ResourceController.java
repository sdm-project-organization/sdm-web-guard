...
public class ResourceController {
    ...
    public ResponseEntity<Void> createResource(
            ...
            @Validated @RequestBody ResourceEntity resourceResource,
            UriComponentsBuilder uriComponentsBuilder) throws Exception {
        /*ResourceEntity resource = resourceService.save(resourceResource.toInsert().toEntity());*/
        ResourceEntity resource = resourceService.save(resourceResource);
    ...
    public ResourceEntity getResource(@PathVariable int resourceId) throws Exception {
    ...
    public ResponseEntity<Void> updateResource(
            ...
            @Validated @RequestBody ResourceEntity resourceResource) throws Exception {
